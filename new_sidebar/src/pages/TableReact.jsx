...
const TableReact = () => {
  ...
  return (
    <div className="h-auto bg-white flex  items-center justify-center pt-10 pb-10 mb-5">
        ...
        <div className="w-full overflow-x-scroll md:overflow-auto  max-w-7xl 2xl:max-w-none">
          <table className="table-auto overflow-scroll md:overflow-auto w-full text-left font-inter border ">
           ...
           `}
                ...
                <th className="py-3 px-3 text-[#212B36] sm:text-base font-bold whitespace-nowrap min-w-auto">
                  Show
                </th>
              </tr>
            </thead>
