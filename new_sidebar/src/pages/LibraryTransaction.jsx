...
const LibraryTransaction = () => {
  ...
  const myResponse = async () => {
    try {
      ...
      const response = axios.get(
        "http://localhost:2525/library/transaction/4F5455324D54453D",
        {
  ...
  // show single data
  const showDetail = async (library_transaction_id) => {
    try {
      const accessToken =
        "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxLGR1cmdlc2giLCJpc3MiOiJXYXRlciBTb2Z0d2FyZXMiLCJyb2xlcyI6IltST0xFX1VTRVJdIiwiaWF0IjoxNzE2MTg0MTIxLCJleHAiOjE3MTYyNzA1MjF9.kuFUJQx9ExYcQLijpX9jr5YWYVIQ2wQHcZoVtsgW4CRgpJDQzkLQmKjA-FPmtDlp0pZ8Zz42AlfgwKqAOuh5bA";
      const response = axios.get(
        `http://localhost:2525/library/transaction/edit/4F5455324D54453D/${library_transaction_id}`,
  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className=" p-5  rounded-2xl shadow-2xl overflow-hidden mx-auto max-w-sm lg:max-w-7xl bg-white"
                    ...
                    Name <FaSort />
                          ...
                          <tbody>
                            {records
                              ...
                              .map((names, index) => (
                                <tr key={index}>
                                  <td>{names.library_transaction_id}</td>
                                  <td>{names.borrowed_date}</td>
                                  <td>{names.returned_date}</td>
                                  <td>{names.due_date}</td>
                                  <td>{names.fine}</td>
                                  ...
                                  >
                                    <button
                                      ...
                                      onClick={(e) =>
                                        showDetail(names.library_transaction_id)
                                      }
                                    >
                                      <FaEye />
                                    </button>
                      ...
                      <div className="relative h-full p-3 bg-white border-2 border-blue-500 rounded-lg">
                        ...
                        <div className="flex items-center -mt-1">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Row No : {modeldata.library_transaction_id}
                          </h3>
                        </div>
                        ...
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Borrowed Date : {modeldata.borrowed_date}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Due Date : {modeldata.due_date}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Fine Amount : {modeldata.fine}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Return Date : {modeldata.returned_date}
                          </h3>
                        </span>
                      </div>
                    </div>
