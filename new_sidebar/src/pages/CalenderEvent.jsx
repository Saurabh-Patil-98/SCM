...
const CalenderEvent = () => {
  ...
  const myResponse = async () => {
    try {
      ...
      const response = axios.get(
        "http://localhost:2525/calendarevent/4F5455324D54453D",
        {
  ...
  // show single data
  const showDetail = async (event_id) => {
    try {
      const accessToken =
        "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxLGR1cmdlc2giLCJpc3MiOiJXYXRlciBTb2Z0d2FyZXMiLCJyb2xlcyI6IltST0xFX1VTRVJdIiwiaWF0IjoxNzE2NDM5NTQ3LCJleHAiOjE3MTY1MjU5NDd9.0LgLxrYtAqugeI9wLsiaoFgk2xbc76EuM2xbDDtKOkAntrelJkAocbQpbPkLnuale-U3Mvef8VqV5Z0lg8qHdw";
      const response = axios.get(
        `http://localhost:2525/calendarevent/edit/4F5455324D54453D/${event_id}`,
  ...
  return (
    <div>
      ...
      >
        ...
        <div className=" p-5 rounded-2xl shadow-xl overflow-hidden mx-auto  lg:max-w-7xl  bg-white lg:mr-[20px]">
            ...
            <div className="grid xl:grid-cols-2 xl:gap-6">
              <div className="relative z-0 mb-6 w-full group">
                <input
                  ...
                  required
                />
                <label className="absolute cursor-text left-0 -top-3 text-sm text-gray-900 bg-white mx-1 px-1 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-placeholder-shown:top-2 peer-focus:-top-3 peer-focus:text-sky-600 peer-focus:text-sm transition-all">
                  Start Date
                </label>
              </div>
              <div className="relative z-0 mb-6 w-full group">
                    ...
                    Name <FaSort />
                          ...
                          <tbody>
                            {records
                              ...
                              .map((names, index) => (
                                <tr key={index}>
                                  <td>{names.event_id}</td>
                                  <td>{names.event_name}</td>
                                  <td>{names.event_type}</td>
                                  <td>{names.start_date}</td>
                                  <td>{names.end_date}</td>
                                  <td>{names.event_description}</td>
                                  <td
                                    data-toggle="tooltip"
                    ...
                    >
                      ...
                      <div className="relative h-full p-3 bg-white border-2 border-blue-500 rounded-lg">
                        ...
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Event name : {modeldata.event_name}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Event type : {modeldata.event_type}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Start date : {modeldata.start_date}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            End date : {modeldata.end_date}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Event Description : {modeldata.event_description}
                          </h3>
                        </span>
                      </div>
                    </div>
