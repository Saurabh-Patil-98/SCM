...
const Teacher = () => {
  ...
  const myResponse = async () => {
    try {
      ...
      const response = axios.get(
        "http://localhost:2525/teacher/attendences/4F5455324D54453D",
        {
  ...
  // show single data
  const showDetail = async (teacher_attendance_id) => {
    try {
      const accessToken =
        "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxLGR1cmdlc2giLCJpc3MiOiJXYXRlciBTb2Z0d2FyZXMiLCJyb2xlcyI6IltST0xFX1VTRVJdIiwiaWF0IjoxNzE2NTQ4OTM3LCJleHAiOjE3MTY2MzUzMzd9.dKzK8OZcKxqg7SN2IvW2oMceCcZzw2cTkzREWNzGKiOXX3WffBBSXb3s1w97bcsi2CrbgRzmAyrHy35iCv4APQ";
      const response = axios.get(
        `http://localhost:2525/teacher/attendences/edit/4F5455324D54453D/${teacher_attendance_id}`,
  ...
  return (
    <div className="my-6 px-4 sm:px-8 md:px-12">
      <div className="grid sm:grid-cols-2 gap-16 p-8 mx-auto max-w-6xl bg-white rounded-md text-[#333] font-[sans-serif] shadow-2xl">
        <div>
            ...
            <ul className="mt-3">
              <li className="flex items-center">
                ...
                >
                  ...
                  <strong>info@watersoftwares.in</strong>
                </a>
              </li>
            </ul>
          </div>
                    ...
                    Name <FaSort />
                            ...
                            <tbody>
                              {records
                                ...
                                .map((names, index) => (
                                  <tr key={index}>
                                    <td>{names.teacher_attendance_id}</td>
                                    <td>{names.check_in_time}</td>
                                    <td>{names.check_out_time}</td>
                                    <td>{names.date}</td>
                        ...
                        <div className="relative h-full p-3 bg-white border-2 border-blue-500 rounded-lg">
                          ...
                          <div className="flex items-center -mt-1">
                            <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                              Row No : {modeldata.teacher_attendance_id}
                            </h3>
                          </div>
                          ...
                          <span className="my-2 text-gray-600">
                            <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                              Check In Time : {modeldata.check_in_time}
                            </h3>
                          </span>
                          <span className="my-2 text-gray-600">
                            <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                              Check Out Time : {modeldata.check_out_time}
                            </h3>
                          </span>
                          <span className="my-2 text-gray-600">
                            <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
