  ...
  const myResponse = async () => {
    try {
      ...
      const response = axios.get(
        "http://localhost:2525/feestransaction/4F5455324D54453D",
        {
  ...
  const showDetail = async (fee_id) => {
    try {
      const accessToken =
        "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxLGR1cmdlc2giLCJpc3MiOiJXYXRlciBTb2Z0d2FyZXMiLCJyb2xlcyI6IltST0xFX1VTRVJdIiwiaWF0IjoxNzE2NTQ4OTM3LCJleHAiOjE3MTY2MzUzMzd9.dKzK8OZcKxqg7SN2IvW2oMceCcZzw2cTkzREWNzGKiOXX3WffBBSXb3s1w97bcsi2CrbgRzmAyrHy35iCv4APQ";
      const response = axios.get(
        `http://localhost:2525/feestransaction/4F5455324D54453D/${fee_id}`,
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="relative z-0 mb-6 w-full group">
              <textarea
                ...
                placeholder=""
                value={inputs.transaction_description || ""}
                onChange={handleChange}
                required
              />
              <label
                    ...
                    Name <FaSort />
                          ...
                          <tbody>
                            {records
                              ...
                              .map((names, index) => (
                                <tr key={index}>
                                  <td>{names.transaction_id}</td>
                                  <td>{names.amount_type}</td>
                                  <td>{names.transaction_date}</td>
                                  <td>{names.next_due_date}</td>
                                  <td>{names.bill_status}</td>
                                  <td>{names.paid_amount}</td>
                                  <td
                                    data-toggle="tooltip"
                                  ...
                                  >
                                    <button
                                      ...
                                      onClick={(e) =>
                                        showDetail(names.transaction_id)
                                      }
                                    >
                                      <FaEye />
                                    </button>
                      ...
                      <div className="relative h-full p-3 bg-white border-2 border-blue-500 rounded-lg">
                        ...
                        <div className="flex items-center -mt-1">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Row No : {modeldata.transaction_id}
                          </h3>
                        </div>
                        ...
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Transaction Date : {modeldata.transaction_date}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Due Date : {modeldata.next_due_date}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Bill Status : {modeldata.bill_status}
                          </h3>
                        </span>
                        <span className="my-2 text-gray-600">
                          <h3 className="my-2 ml-3 text-lg font-bold text-gray-800">
                            Paid Amount : {modeldata.paid_amount}
                          </h3>
                        </span>
                      </div>
                    </div>
